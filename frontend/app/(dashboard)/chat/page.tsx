                  ...
                  {m.role === "user" ? (
                    ...
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        thead: ({ node, ...props }) => <thead className="bg-surface-container/50" {...props} />,
                        tr: ({ node, ...props }) => <tr className="border-b border-outline-variant/30" {...props} />,
                        th: ({ node, ...props }) => <th className="border border-outline-variant/30 px-4 py-2 font-semibold text-left" {...props} />,
                        td: ({ node, ...props }) => <td className="border border-outline-variant/30 px-4 py-2" {...props} />,
